...
# ##################################################### #
# 前往https://console.picovoice.ai/，注册自己的账号（注册后会得到ACCESS_KEY），并在Wake Word界面训练自己的关键词
ACCESS_KEY = '***'	# 更换成自己的
MODEL_PATH = './porcupine_source/porcupine_params_zh.pv' #如果使用中文的唤醒词，则无需改动；若使用其他语言，则到github上下载对应的语音识别包
KEYWORD_PATHS = './porcupine_source/swing.ppn' #更换为自己的识别词ppn文件
# ##################################################### #
